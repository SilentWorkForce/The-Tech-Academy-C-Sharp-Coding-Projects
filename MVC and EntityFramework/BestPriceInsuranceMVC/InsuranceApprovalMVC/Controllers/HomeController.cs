using InsuranceApprovalMVC.Models;
using System;
...
namespace InsuranceApprovalMVC.Controllers
{
    public class HomeController : Controller
    {
        private readonly string connectionString = @"Data Source=C5T-PC-2\SQLEXPRESS;Initial Catalog=BestPriceDb;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
